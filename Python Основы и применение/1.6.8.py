...
представляющую собой расширенную структуру стек.
...
и затем как результат операции сложения на вершину
...
Примечание
Для добавления элемента на стек используется метод append,
а для снятия со стека – метод pop.
