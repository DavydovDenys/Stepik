...
что некоторые исключения можно не ловить,
...
и понять какие из исключений можно и не ловить,
...
обработку которого можно удалить из кода,
не изменив при этом поведение программы.
Имена следует выводить в том же порядке,
